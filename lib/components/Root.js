...
class Root extends Component {
  ...
  render(props, state) {
    ...
    puyopuyoFieldSquareMatrix.forEach(lineSquares => {
      lineSquares.forEach(square => {
        const absoluteX = square.columnIndex + PUYOPUYO_FIELD_RECT.x;
        const absoluteY = square.rowIndex + PUYOPUYO_FIELD_RECT.y;
