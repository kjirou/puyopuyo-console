...
describe('lib/Store', function() {
  describe('Static methods', function() {
    ...
    describe('_findMatchedSquaresSets', function() {
      ...
      it('should work in the simplest case', function() {
        ...
        assert.strictEqual(sets[0][0].colorType, 'RED');
        assert.strictEqual(sets[0][0].rowIndex, 0);
        assert.strictEqual(sets[0][0].columnIndex, 0);
        assert.strictEqual(sets[0][1].colorType, 'RED');
        assert.strictEqual(sets[0][2].colorType, 'RED');
        assert.strictEqual(sets[0][3].colorType, 'RED');
        assert.strictEqual(sets[0][3].rowIndex, 0);
        assert.strictEqual(sets[0][3].columnIndex, 3);
      });

      it('should work in the case of horizontal arrangement', function() {
        const matrix = createMatrixFromText(
          [
            ' RRRR ',
          ].join('\n')
        ...
        assert.strictEqual(sets[0][3].colorType, 'RED');
        assert.strictEqual(sets[0][3].rowIndex, 0);
        assert.strictEqual(sets[0][3].columnIndex, 4);
      });

      it('should work in the case of vertical arrangement', function() {
        const matrix = createMatrixFromText(
          [
            ' ',
            'R',
        ...
        assert.strictEqual(sets[0][0].colorType, 'RED');
        assert.strictEqual(sets[0][0].rowIndex, 1);
        assert.strictEqual(sets[0][0].columnIndex, 0);
        assert.strictEqual(sets[0][1].colorType, 'RED');
        assert.strictEqual(sets[0][2].colorType, 'RED');
        assert.strictEqual(sets[0][3].colorType, 'RED');
        assert.strictEqual(sets[0][3].rowIndex, 4);
        assert.strictEqual(sets[0][3].columnIndex, 0);
      });

      it('should work in the case of box shape', function() {
        const matrix = createMatrixFromText(
          [
            '      ',
            '  RR  ',
        ...
        assert.strictEqual(sets[0][2].columnIndex, 2);
        assert.strictEqual(sets[0][3].colorType, 'RED');
